function [ChnlEstCell]=SparseChnlEstGlobal_Par(SysSturct,ChnlEstCell,ChnlCell,DecodeStruct,Niter)
...
for iter=1:Niter
    ...
    for n=1:N
        ...
        for m=1:M
            blf_alpha_m=SubChnlEstCell{m,n}.blf_alpha_m;
            blf_alpha_v=SubChnlEstCell{m,n}.blf_alpha_v;
    ...
    for m=1:M
        for n=1:N
            pilotSubcIndx=pilotSubcIndxTotal(n,:);
            GlobalSubcIndx=union(pilotSubcIndx,dataSubcIndx);   %改变index位置3
            %GlobalSubcIndx=dataSubcIndx; 
            Phi=ChnlCell{m,n}.Phi;
            phi=Phi(GlobalSubcIndx,:);
            msg_fy2h_m=SubChnlEstCell{m,n}.msg_fy2h_m;
